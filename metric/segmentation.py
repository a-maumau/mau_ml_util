...
class SegmentationMetric(object):
    ...
    def calc_mean_jaccard_index(self, ignore=[255]):
        ...
        for class_id in range(self.class_num):
            ...
            iou["class_{}".format(class_id)] = (self.class_matrix[class_id, class_id] /
    ...
    def calc_mean_precision(self, ignore=[255]):
        ...
        for class_id in range(self.class_num):
            ...
            precision["class_{}".format(class_id)] = (self.class_matrix[class_id, class_id] /
                                               (torch.sum(self.class_matrix[class_id, :])-self.class_matrix[class_id, class_id])).cpu().item()
