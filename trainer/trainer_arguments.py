...
def add_trainer_arguments(parser):
    ...
    parser.add_argument('--validation_sample_batch_num', type=int, default=1,
                        help='num of saving sample in validation. value denotes batch num.')
    ...
    parser.add_argument('--decay_value', type=float, default=0.1,
                        help="decay learning rate with count of args:decay_every in this factor.")
    ...
    parser.add_argument('--notify_type', type=str, nargs='*', default=["slack"],
                        help="you can pick up multiple type from [slack mail twitter].")
